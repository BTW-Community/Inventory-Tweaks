...
public class InvTweaksConst {
    ...
    public static final String DEFAULT_CONFIG_FILE = "/invtweaks/DefaultConfig.dat";
    public static final String DEFAULT_CONFIG_TREE_FILE = "/invtweaks/DefaultTree.dat";
